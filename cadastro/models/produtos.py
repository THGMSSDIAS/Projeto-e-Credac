...
class Cadastro_itens_sped(models.Model):
    ...
    descricao_prod = models.CharField('Descrição do Produto', max_length=250, blank=True, null=True)
    ...
    genero = models.CharField('Gênero', max_length=255, null=True, blank=True)
