...
class Notas_participantes(models.Model):
    ...
    numero_importacao = models.CharField('Número do Documento', max_length=50, blank=True, null=True)
    cod_situacao =  models.CharField('Código de Situação', max_length=4, blank=True, null=True)
